 ...
 */
public class UNWEIGTEDGRAPHController implements Initializable {

    @FXML
    private AnchorPane idUNWEIGHTEDAnchorPane;
    ...
    public AnchorPane getIdUNWEIGHTEDAnchorPane() {
        return idUNWEIGHTEDAnchorPane;
    }

    public void setIdUNWEIGHTEDAnchorPane(AnchorPane idUNWEIGHTEDAnchorPane) {
        this.idUNWEIGHTEDAnchorPane = idUNWEIGHTEDAnchorPane;
    }
