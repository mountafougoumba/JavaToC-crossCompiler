 ...
 */
public class REDBLACKController implements Initializable {
 @FXML
    private AnchorPane idREDBLACKAnchorPane;
    ...
    public AnchorPane getIdREDBLACKAnchorPane() {
        return idREDBLACKAnchorPane;
    }

    public void setIdREDBLACKAnchorPane(AnchorPane idREDBLACKAnchorPane) {
        this.idREDBLACKAnchorPane = idREDBLACKAnchorPane;
    }
